...
namespace AppAdvisory.ww
{
	[InitializeOnLoad]
	public class WelcomeWW : EditorWindow 
	{
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/14juiHDYwquCmDtqWyfoVnV-I77FGgpBikwDPm3rOZjY/edit?usp=sharing";
		private const string RATEUS_URL = "http://u3d.as/pDV";

		private const string NAME_OF_THE_GAME = "WW";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
